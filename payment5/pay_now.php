...
$qr_code_url = "https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=" . urlencode($orders); // you can use google chart api
 ?>
<body>
 ...
 <form id="paymentForm" action="https://upi.cryptrx.in/instantpay/googlepay/payment-verify" method="post">
    <!-- Other input fields -->
