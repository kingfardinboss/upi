...
<head>
    ...
    <title>ToPayments</title>
    <link rel="icon" type="image/png" href="auth/assets/img/hdfc.png" />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		  <p>The ToPayments does not provide any payment gateway services, UPI accounts, or UPI merchant accounts.</p>
      ...
      <div class="modal-footer">
        ...
        <main class="main" id="top">
            <nav class="navbar navbar-expand-lg navbar-light sticky-top" data-navbar-on-scroll="data-navbar-on-scroll">
                <div class="container">
                    <a class="navbar-brand" href="index.html"><img src="/auth/assets/img/hdfc.png" height="45" width="150" alt="logo" /></a>
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="navbar-toggler-icon"> </span>
                    </button>
                    <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item"><a class="nav-link" aria-current="page" href="index.html"><h4>Home</h4></a></li>
                            <li class="nav-item"><a class="nav-link" aria-current="page" href="#feature"><h4>Feature</h4></a></li>
                            <li class="nav-item"><a class="nav-link" aria-current="page" href="#pricing"><h4>Pricing</h4></a></li>
                            <li class="nav-item"><a class="nav-link" aria-current="page" href="#helpdesk"><h4>HelpDesk</h4></a></li>
                        </ul>
                        <div class="d-flex ms-lg-4"><a class="btn btn-secondary-outline" href="auth/index"><h4>Login</h4></a><a class="btn btn-primary ms-3" href="auth/register"><h4>Register</h4></a></div>
                    </div>
                </div>
            </nav>
            <section class="pt-4" style="margin-bottom: -20px;background-image: url(home/upiapp/wavenew.svg);background-size: cover;color: white;">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-6 text-md-start text-center py-5">
                            <h1 class="mb-4 fs-9 fw-bold text-white"> QR Code Generator Pay via UPI Feature</h1>
                            ...
                            <div class="text-center text-md-start">
                                <a class="btn bg-white me-3 btn-lg" href="auth/register" role="button"><span class="fas fa-bolt me-2"></span> Try for free</a>
                            </div>
                        </div>
                        <div class="col-md-6 text-end"><img class="pt-7 pt-md-0 img-fluid" src="home/upiapp/qrcode.svg" alt="" style="width:1000px"/></div>
                    </div>
                </div>
            </section>
                ...
                <div class="container">
                    ...
                    <div class="row p-2">
                        <div class="col-lg-12 col-sm-12 text-center">
                            <img class="mb-3" src="home/upiapp/qrall.jpg" width="70%" alt="upiapp">
                        </div>
                    </div>
                </div>
                <!-- end of .container-->
            ...
            <!-- ============================================-->
            <!-- <section> begin ============================-->
            <section class="pt-4" id="feature" style=" background-image: url(home/upiapp/wavenew.svg); background-size: cover; ">
                <div class="container py-5">
                    <div class="row">
                        <div class="col-lg-6">
                            <h2 class="mb-2 fs-7 fw-bold mb-4 text-white">QR Code Generator Api</h2>
                            <h4 class="fs-1 fw-bold text-white">Multiple  Merchant.</h4>
                            ...
                            <h4 class="fs-1 fw-bold text-white">Robust Security</h4>
                            <p class="mb-4 fw-medium text-white">
                                24*7 Robust api.
                            </p>
                            <h4 class="fs-1 fw-bold text-white">Dynamic  QR Code</h4>
                            <p class="mb-4 fw-medium text-white">
                        ...
                        <div class="col-lg-6"><img class="img-fluid" src="home/upiapp/scannpay.svg" alt="" /></div>
                    </div>
                </div>
                <!-- end of .container-->
            </section>
            ...
            <!-- ============================================-->
             <!-- ============================================-->
            <!-- <section> begin ============================-->
            <section class="pt-2 mb-4" id="pricing" style=" background-image: url(home/upiapp/wavenew.svg); background-size: cover; ">
                <div class="container py-5">
    ...
    <tr>
        <td><i class="icon-md text-primary me-2" data-feather="check"></i></td>
        <td><p style="color:red;">HDFC Merchant</p></td>
    </tr>
    <tr>
        <td><i class="icon-md text-primary me-2" data-feather="check"></i></td>
        <td><p style="color:red;">Paytm Business</p></td>
    </tr>
    <tr>
        <td><i class="icon-md text-primary me-2" data-feather="check"></i></td>
        <td><p style="color:red;">PhonePe Business</p></td>
    </tr>
    <tr>
        <td><i class="icon-md text-primary me-2" data-feather="check"></i></td>
        <td><p style="color:red;">BharatPe Business</p></td>
    </tr>
    <tr>
    ...
    <tr>
        <td><i class="icon-md text-danger me-2" data-feather="x"></i></td>
        <td><p style="color:red;">Wordpress Plugin</p></td>
    </tr>
    <tr>
        <td><i class="icon-md text-danger me-2" data-feather="x"></i></td>
    ...
    <tr>
        ...
        <td><p>24*7 WhatsApp Support</p></td>
                            ...
                            <div class="col-md-3 mb-4">
                                <div class="card plan-box text-center">
                                    <div class="card-header">
                                        <h4 class="card-title mt-2">Starter</h4>
                                        <h2 class="text-center">₹299</h2>
                                        <p class="card-category">1 Month</p>
                                    </div>
                                    <div class="card-body bg-white">
                                        <div class="mb-2 text-primary">
                                            <b style="font-weight:700;font-size:1rem;">3000 Transactions</b></div>
                                        <table class="mx-auto" style=" line-height: 0.99em; ">
                                       <tbody>
    <tr>
        <td><i class="icon-md text-primary me-2" data-feather="check"></i></td>
                            ...
                            <div class="col-md-3 mb-4">
                                <div class="card plan-box text-center">
                                    <div class="card-header">
                                        ...
                                        <h2 class="text-center">₹449</h2>
                                        <p class="card-category">1 Month</p>
                                    </div>
                                    <div class="card-body bg-white">
                                        <div class="mb-2 text-primary">
                                            <b style="font-weight:700;font-size:1rem;">10000 Transactions</b></div>
                                        <table class="mx-auto" style=" line-height: 0.99em; ">
                                        <tbody>
    <tr>
        <td><i class="icon-md text-primary me-2" data-feather="check"></i></td>
    ...
    <tr>
        ...
        <td><p>24*7 WhatsApp Support</p></td>
                            ...
                            <div class="col-md-3 mb-4">
                                <div class="card plan-box text-center">
                                    <div class="card-header">
                                        <h4 class="card-title mt-2">Enterprise</h4>
                                        <h2 class="text-center">₹699</h2>
                                        <p class="card-category">1 Month</p>
                                    </div>
                                    <div class="card-body bg-white">
                                        <div class="mb-2 text-primary">
                                            <b style="font-weight:700;font-size:1rem;">30000 Transactions</b></div>
                                        <table class="mx-auto" style=" line-height: 0.99em; ">
                                       <tbody>
    <tr>
        <td><i class="icon-md text-primary me-2" data-feather="check"></i></td>
    ...
    <tr>
        ...
        <td><p>24*7 WhatsApp Support</p></td>
                            ...
                            <div class="col-md-3 mb-4">
                                <div class="card plan-box text-center">
                                    <div class="card-header">
                                        <h4 class="card-title mt-2">GOLD PLAN</h4>
                                        <h2 class="text-center">₹2999</h2>
                                        <p class="card-category">1 Year</p>
                                    </div>
                                    <div class="card-body bg-white">
                                        <div class="mb-2 text-primary">
                                            <b style="font-weight:700;font-size:1rem;">12000 Transactions</b></div>
                                        <table class="mx-auto" style=" line-height: 0.99em; ">
                                        <tbody>
    <tr>
        <td><i class="icon-md text-primary me-2" data-feather="check"></i></td>
    ...
    <tr>
        ...
        <td><p>24*7 WhatsApp Support</p></td>
                            ...
                            <div class="col-md-3 mb-4">
                                <div class="card plan-box text-center">
                                    <div class="card-header">
                                        <h4 class="card-title mt-2">DIMOND PLAN</h4>
                                        <h2 class="text-center">₹4999</h2>
                                        <p class="card-category">1 Year</p>
                                    </div>
                                    <div class="card-body bg-white">
                                        <div class="mb-2 text-primary">
                                            <b style="font-weight:700;font-size:1rem;">5000000 Transactions</b></div>
                                        <table class="mx-auto" style=" line-height: 0.99em; ">
                                        <tbody>
    <tr>
        <td><i class="icon-md text-primary me-2" data-feather="check"></i></td>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-6 text-center">
                            ...
                            <button class="btn btn-primary btn-md" onclick="location.href='https://wa.me/+918619170399'"><i class="fab fa-whatsapp fa-fw fa-lg"></i> Chat our WhatsApp</button>
                        </div>
                    </div>
                </div>
                <!-- end of .container-->
            ...
            <section class="pb-2 pb-lg-5" style="margin-top:-5%;">
                <div class="container">
                    <div class="row border-top border-top-secondary pt-7">
                        <div class="col-lg-3 col-md-6 mb-4 mb-md-6 mb-lg-0 mb-sm-2 order-1 order-md-1 order-lg-1"><img class="mb-2" src="../warobot.in/assets/website/u2-removebg-preview.png" width="184" alt="" />
                        ...
                        <div class="col-lg-3 col-md-6 mb-4 mb-lg-0 order-3 order-md-3 order-lg-2">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="mb-2"><a class="link-900 text-secondary text-decoration-none" href="https://wa.me/+918619170399" target="_blank">Web Development</a></li>
                                <li class="mb-2"><a class="link-900 text-secondary text-decoration-none" href="https://wa.me/+918619170399" target="_blank">WhatsApp Api</a></li>
                                <li class="mb-2"><a class="link-900 text-secondary text-decoration-none" href="https://wa.me/+918619170399" target="_blank">Recharge Api</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="container border-top py-3">
                        <div class="row justify-content-between">
                            <div class="col-12 col-md-auto mb-1 mb-md-0">
                                <p class="mb-0">&copy; 2023 ToPayments</p>
                            </div>
                            <div class="col-12 col-md-auto">
                                <p class="mb-0">Made with<span class="fas fa-heart mx-1 text-danger"> </span>by <a class="text-decoration-none ms-1" href="#" target="_blank">ToPayments</a></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from upigetway.com/index by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Oct 2023 17:52:32 GMT -->
</html>
