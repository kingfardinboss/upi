...
<b>Note:</b> Pay Via Upi Button Will Only Work If Your Current Bank Account Joined In Merchant App Support It. Use Of ToPayments In Any Manner That Is Unlawful, Gambling, Crypto Or Betting Is Strictly Prohibited. We Reserve The Right To Terminate Your Account And/or Block Your Access To ToPayments If We Suspect Any Such Activity.
</div>		
<div class="hk-row">
						...
						<div class="row row-card-no-pd">
							<div class="col-md-12">
								<h6 class="btn badge bg-danger text-white mb-4" style="width: 100%;font-size:20px; ">
									...
									<marquee style="color: white;margin-bottom: -8px;" onmouseover="this.stop();" onmouseout="this.start();" direction="left" height="25">HDFC Vyapar Gateway Single API, Single Plan, All Working Fine thank you ToPayments
									</marquee>
								</h6>
