        ...
        if (!empty($existing_order_result)) {
            ...
            exit;
                ...
                if ($bydb_order_hdfc_conn == "Yes") {
                    ...
                    $txn_data = file_get_contents("https://upi.cryptrx.in/HDFCSoft/payrequest.php?sessionid=$db_seassion&cnumber=$customer_mobile&amount=$amount&no=$customer_mobile&tidList=$tidlist&dis=$diss");
...
setXbyY($sql);
                ...
                elseif ($bydb_order_phonepe_conn == "Yes") {
                    ...
                    if ($expire_date >= $today) {
                        ...
                        $payment_link = "https://upi.cryptrx.in/payment2/instant-pay/" . $link_token;
...
setXbyY($sql);
                ...
                elseif ($bydb_order_paytm_conn == "Yes") {
                    ...
                    if ($expire_date >= $today) {
                        ...
                        // Construct the payment link
                        $payment_link = "https://upi.cryptrx.in/payment3/instant-pay/" . $link_token;
...
setXbyY($sql);
                ...
                elseif ($bydb_order_bharatpe_conn == "Yes") {
                    ...
                    if ($expire_date >= $today) {
                        ...
                        // Construct the payment link
                        $payment_link = "https://upi.cryptrx.in/payment4/instant-pay/" . $link_token;
...
setXbyY($sql);
                ...
                elseif ($bydb_order_googlepay_conn == "Yes") {
                    ...
                    if ($expire_date >= $today) {
                        ...
                        // Construct the payment link
                        $payment_link = "https://upi.cryptrx.in/payment5/instant-pay/" . $link_token;
